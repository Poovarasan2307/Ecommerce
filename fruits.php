...
<body>
  ...
  <!-- <div class="main-top">
    ...
    <nav class="navbar navbar-white  justify-content-between">
        ...
        <li class="nav-item"><a class="nav-link" href="fruits.php">FRESH FRUITS</a></li>
        ...
        <form class="form-inline" id="search-form" style="display:none;">
            <input class="form-control mr-sm-2" name="query" type="search" placeholder="Search" aria-label="Search" id="live">
...
<p class="footer-company">All Rights Reserved. &copy; 2025 <a href="fruits.php">Green Garden</a> 
